...
INSERT INTO question (question_text, difficulty_id, category_id)
VALUES ('Wie heißt der Verein von Bundesliga-Rekordmeister?', 1, @c);
SET @q = LAST_INSERT_ID();
INSERT INTO answer (answer_text, is_correct, question_id) VALUES
...
INSERT INTO question (question_text, difficulty_id, category_id)
VALUES ('Wie heißt die Nationalmannschaft Brasiliens mit ihrem Spitznamen?', 1, @c);
SET @q = LAST_INSERT_ID();
INSERT INTO answer (answer_text, is_correct, question_id) VALUES
    ('Seleção', true, @q),
...
INSERT INTO question (question_text, difficulty_id, category_id)
VALUES ('Wer ist der Rekordtorschütze der Bundesliga-Geschichte?', 2, @c);
SET @q = LAST_INSERT_ID();
INSERT INTO answer (answer_text, is_correct, question_id) VALUES
    ('Gerd Müller', true, @q),
    ('Robert Lewandowski', false, @q),
