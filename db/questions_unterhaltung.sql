...
-- -----------------------------------------------------------------
SET @c = 5; -- see insert.sql for id of unterhaltung
...
INSERT INTO question (question_text, difficulty_id, category_id)
VALUES ('Wie heißt der Zauberer in der Harry-Potter-Reihe?', 1, @c);
SET @q = LAST_INSERT_ID();
INSERT INTO answer (answer_text, is_correct, question_id) VALUES
    ('Harry Potter', true, @q),
...
INSERT INTO question (question_text, difficulty_id, category_id)
VALUES ('Welcher Film gewann als erster den Oscar für "Bester Film" in der Geschichte der Academy Awards?', 3, @c);
SET @q = LAST_INSERT_ID();
INSERT INTO answer (answer_text, is_correct, question_id) VALUES
    ('Wings', true, @q),
